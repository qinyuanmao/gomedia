...
import (
	...
	"github.com/qinyuanmao/gomedia/go-rtsp/sdp"
)
...
type RtspClient struct {
	...
	cache            []byte
	responseHandler  func(res *RtspResponse) error
...
func (client *RtspClient) Start() error {
	...
	client.responseHandler = client.handleOption
...
func (client *RtspClient) KeepAlive(method string) error {
	...
	case GET_PARAMETER:
		...
		req.Fileds[Session] = client.sessionId
		client.responseHandler = client.handleGetParameter
		return client.sendRtspRequest(&req)
	case SET_PARAMETER:
		req := makeSetParameter(client.uri, client.cseq)
		req.Fileds[Session] = client.sessionId
		client.responseHandler = client.handleSetParameter
		return client.sendRtspRequest(&req)
	}
...
func (client *RtspClient) handleResponse(res []byte) (ret int, err error) {
	...
	return ret, client.responseHandler(&response)
}
...
func (client *RtspClient) handleOption(res *RtspResponse) error {
	...
	if client.isRecord {
		...
		client.responseHandler = client.handleAnnounce
		...
		client.responseHandler = client.handleDescribe
...
func (client *RtspClient) handleDescribe(res *RtspResponse) (err error) {
	...
	for i := client.setupStep; i < len(client.sdpContext.Medias); i++ {
		...
		client.responseHandler = client.handleSetup
		return client.sendRtspRequest(&req)
	}
	return nil
}
...
func (client *RtspClient) handleSetup(res *RtspResponse) error {
	...
	if client.isRecord {
		...
		req = &recordReq
		client.responseHandler = client.handleRecord
	} else {
		playReq := makePlay(client.sdpContext.ControlUrl, client.cseq)
		req = &playReq
		client.responseHandler = client.handlePlay
	}
	return client.sendRtspRequest(req)
}
